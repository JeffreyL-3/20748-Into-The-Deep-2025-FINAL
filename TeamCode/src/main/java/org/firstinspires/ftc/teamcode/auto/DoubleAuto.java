...
@Config
@Autonomous(name = "DoubleAuto", group = "Autonomous")
public class DoubleAuto extends LinearOpMode {
    ...
    public static double spinWait = 1;

    public static int wallX=47;
    public static int wallY=-70;

    public static int Initial2Y=-35;
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder movePickupTraj = moveToSubTraj.endTrajectory().fresh()
                ...
                .waitSeconds(spinWait)

                .strafeTo(new Vector2d(47, -40)); //pickup
                //Wait
                //Close claw
        TrajectoryActionBuilder moveInital2Traj = mecanumDrive.actionBuilder(new Pose2d(wallX, wallY, -startAngle))
                .strafeTo(new Vector2d(0, Initial2Y)) //staging
                .turnTo(Math.toRadians(startAngle))
                .waitSeconds(spinWait);
                //Check for vertical slide extension
        TrajectoryActionBuilder moveToSub2Traj = moveInital2Traj.endTrajectory().fresh()
                .strafeTo(new Vector2d(0, -34));
                //Retract vertical slide, snapping piece onto chamber
                //Open claw
        TrajectoryActionBuilder pushTraj = moveToSub2Traj.endTrajectory().fresh()
        ...
        Pose2d wallResetPos = new Pose2d(47, -70, -startAngle);
        Resets resetPinP =  new Resets(mecanumDrive, wallResetPos);
        waitForStart();
        ...
        Actions.runBlocking(
                new ParallelAction(
                        new SequentialAction(
                                ...
                                horizontalExtender.runForTime(extendTime, extendPower),
                                moveToSub,
                                new SleepAction(0.5),
                                ...
                                vertSlide.moveSlide(ParameterManager.highChamberExtendUpPos),
                                moveInital2,
                                new SleepAction(2.0), // TODO: Delete
                                moveToSub,
                                new SleepAction(1.0),
                                vertSlide.moveSlide(ParameterManager.highChamberRetractUpPos),
